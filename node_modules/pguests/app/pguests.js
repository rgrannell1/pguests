...
const pguests = args => {
	...
	process.on(constants.signals.sigint, ( ) => {
		...
		// improve this (listeners? watch file queue?)
		fs.unwatchFile(constants.paths.tcp4)
		fs.unwatchFile(constants.paths.tcp6)
		fs.unwatchFile(constants.paths.udp4)
		fs.unwatchFile(constants.paths.udp6)
